...
Parameter lemma_belong_unique: t_unionfindmodel -> Init.Datatypes.unit.

Lemma root_reachable : forall uf i j n,
    is_root0 uf i -> reach0 uf i j n -> j = i.
Proof.
...
(* Why3 goal *)
Theorem vc_lemma_belong_unique :
  ...
  forall (i:Numbers.BinNums.Z), belong0 self i r1 -> belong0 self i r2 ->
  (r1 = r2).
Proof.
  intros _.
  ...
  rewrite lemma_reach_iff0_spec in Hreach1.
  ...
  - destruct Hreach1 as (Hne & Hpos & Hreach).
    rewrite lemma_reach_iff0_spec in Hreach2.
